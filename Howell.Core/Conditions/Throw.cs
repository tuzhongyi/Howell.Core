...
namespace Howell.Conditions
{
    ...
    internal static class Throw
    {
        ...
        internal static void StringShouldMatchPattern(ConditionValidator<string> validator, string pattern,
            string conditionDescription)
        {
            string condition = GetFormattedConditionMessage(validator, SR.StringShouldMatchPatternX,
                conditionDescription, validator.ArgumentName, pattern.Stringify());
            validator.ThrowException(condition);
        }
