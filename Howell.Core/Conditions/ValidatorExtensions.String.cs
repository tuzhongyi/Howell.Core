...
namespace Howell.Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        /// <returns>The specified <paramref name="validator"/> instance.</returns>
        /// <exception cref="ArgumentException">Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the specified <paramref name="validator"/> matches <paramref name="pattern"/>, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.</exception>
        /// <exception cref="ArgumentNullException">Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the specified <paramref name="validator"/> is a null reference and <paramref name="pattern"/> is not a null reference, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.</exception>
        /// <exception cref="PostconditionException">Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the specified <paramref name="validator"/> matches <paramref name="pattern"/>, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Ensures{T}(T,string)">Ensures</see> extension method.</exception>
        public static ConditionValidator<string> MatchPattern(this ConditionValidator<string> validator, string pattern)
        {
            return MatchPattern(validator, pattern,null);
        }
        /// <summary>
        /// Checks whether the value does match the specified <paramref name="pattern"/>  
        /// using the specified regular expressions.
        ...
        /// <exception cref="ArgumentNullException">Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the specified <paramref name="validator"/> is a null reference and <paramref name="pattern"/> is not a null reference, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.</exception>
        /// <exception cref="PostconditionException">Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the specified <paramref name="validator"/> matches <paramref name="pattern"/>, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Ensures{T}(T,string)">Ensures</see> extension method.</exception>
        public static ConditionValidator<string> MatchPattern(this ConditionValidator<string> validator, string pattern, string conditionDescription)
        {
            string validatorValue = validator.Value;
            Regex reg = new Regex(pattern, RegexOptions.Compiled);
            bool valueIsValid =
                (validatorValue == null && pattern == null) ||
                (validatorValue != null && pattern != null && reg.IsMatch(validatorValue));

            if (!valueIsValid)
            {
                Throw.StringShouldMatchPattern(validator, pattern, conditionDescription);
            }
